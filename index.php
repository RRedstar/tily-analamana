        ...
        <div class="container">
            <div id="formulaire">
                <form action="send_email.php" method="post">
                    ...
                    <div class="btn-div">
                        <input id="submit" type="button" value="Hisoratra">
                    </div>
                </form>
            </div>
            ...
            <div id="informations">
                ...
                <h2>FITAOVANA</h2>
                <div>
                    <p>Fanamiana ara-dalana</p>
                    <p>Baiboly sy fihirana</p>
                    <p>Ditaovana fitondra mivory</p>
                    <p>Lamba firakotra</p>
                </div>
                
                <h2>FOTOANA</h2>
                <div>
                    <p>Fanombohana: Asabotsy 30 Novambra 2024</p>
                    <p>@7 ora maraina</p>
                    <p>Famaranana: Alahady 01 Desambra 2024</p>
                    <p>@7 ora maraina</p>
                </div>
    
                <h2>TOERANA</h2>
                <div>
                    <p>Kolejy Teolojika Mamory Ivato</p>
                </div>
    
                <h2>SARANDASY</h2>
                <div>
                    <p>Vola: 10.000ar</p>
                    <p>Vary: 2kp isan'olona</p>
                </div>
            </div>
